...
var item_scenes :=[
	preload("res://lessons/gem.tscn"),preload("res://lessons/healthpack.tscn")]
...
func _on_timer_timeout() -> void:
	...
	random_position.x =randf_range(0.0,viewpoint_size.x)
	random_position.y =randf_range(0.0,viewpoint_size.y)
